...
__attribute__((section("__versions"))) = {
	...
	{ 0x334bd2ac, __VMLINUX_SYMBOL_STR(rt2800_disable_radio) },
	{ 0x30fef202, __VMLINUX_SYMBOL_STR(rt2800_wait_csr_ready) },
	...
	{ 0x3daabbf8, __VMLINUX_SYMBOL_STR(rt2x00usb_register_read_async) },
...
MODULE_INFO(srcversion, "3667012619B1C813FAF00AF");
