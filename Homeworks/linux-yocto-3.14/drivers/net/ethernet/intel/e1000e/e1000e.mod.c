...
__attribute__((section("__versions"))) = {
	...
	{ 0x89869545, __VMLINUX_SYMBOL_STR(pci_disable_link_state_locked) },
	...
	{ 0xa96b0114, __VMLINUX_SYMBOL_STR(pci_request_selected_regions_exclusive) },
...
MODULE_INFO(srcversion, "6CF388DAB7E0A7AEE3E46E7");
